...
class Team(models.Model) :
    ...
    reserver_id = models.ForeignKey("users.User", on_delete=models.CASCADE,db_column="reserver_id")
...
class TeamMember(models.Model) :
    ...
    member_id = models.ForeignKey("users.User",on_delete=models.CASCADE,db_column="member_id")
    class Meta:
